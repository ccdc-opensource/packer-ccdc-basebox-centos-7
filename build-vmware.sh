...
rm -rf ./output//packer-centos-7.9-x86_64-vmware
...
mv output/ccdc-basebox/centos-7.9.vmware.box output/ccdc-basebox/centos-7.9.$(date +%Y%m%d).0.vmware_desktop.box
