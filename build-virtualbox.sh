...
mkdir -p output
rm -rf ./output/packer-centos-7.8-x86_64-virtualbox
...
mv output/ccdc-basebox/centos-7.8.virtualbox.box output/ccdc-basebox/centos-7.8.$(date +%Y%m%d).0.virtualbox.box
